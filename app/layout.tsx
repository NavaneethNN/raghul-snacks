...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body><CartProvider><div className="announcement"><span>📦 Free shipping on orders above ₹499</span><span>🌾 Stone-ground ingredients</span><span>❤️ Handmade every morning</span><span>⭐ 5000+ happy customers</span><span>🔥 Limited weekend offers</span></div><StoreHeader /><main>{children}</main><footer><div className="brand"><span>Raghul</span> Snacks</div><p>Traditional snacks, made with ingredients you can recognise.</p><div><a href="/faq">FAQs</a><a href="/policies/privacy">Privacy</a><a href="/policies/terms">Terms</a></div></footer></CartProvider></body></html>;
}
