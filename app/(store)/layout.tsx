        ...
        <div className="footer-container">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a href="https://wa.me/918667829041" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://www.instagram.com/raghul_delights?igsh=emg3b3plYmkxeWlo" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
          ...
          <div className="footer-links">
            <div className="footer-column">
              ...
              <ul>
                ...
                <li><Link href="/shop?tab=combos">Combos</Link></li>
                <li><Link href="/shop/kadalai">Millet Laddu</Link></li>
