export default function ShippingPage() {
  return (
    <section className="policy-page">
      ...
      <h1>Fresh snacks, delivered to your door.</h1>
      ...
      <div className="policy-content">
        ...
        <ul>
          ...
          <li><strong>South India (Karnataka, Kerala, Andhra Pradesh, Telangana):</strong> 3-4 business days</li>
          <li><strong>West India (Maharashtra, Gujarat, Goa):</strong> 4-5 business days</li>
          <li><strong>East India (West Bengal, Odisha, etc.):</strong> 4-5 business days</li>
          <li><strong>North India (Delhi, UP, Punjab, etc.):</strong> 5-7 business days</li>
          <li><strong>North East & Remote Areas:</strong> 7-10 business days</li>
        </ul>
