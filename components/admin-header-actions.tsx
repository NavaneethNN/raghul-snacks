    ...
    <>
      ...
      >
        ...
        <div style={{ padding: "20px 20px 16px", borderBottom: "1px solid var(--line)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <button onClick={() => setOpen(false)} style={{ background: "none", border: "none", cursor: "pointer", color: "#9ca3af", padding: 4, display: "flex" }} aria-label="Close">
            ...
            <>
              {data.newOrders > 0 && (
                <NotifCard
                  ...
                  title="New Orders"
                  description={`${data.newOrders} paid order${data.newOrders > 1 ? "s" : ""} placed in the last 24 hours waiting to be packed.`}
                  href="/admin/orders"
              ...
              {data.unreadMessages > 0 && (
                <NotifCard
                  ...
                  description={`${data.unreadMessages} contact enquir${data.unreadMessages > 1 ? "ies" : "y"} waiting for your reply.`}
                  href="/admin/messages"
              ...
              {data.pendingReviews > 0 && (
                <NotifCard
                  ...
                  description={`${data.pendingReviews} customer review${data.pendingReviews > 1 ? "s" : ""} waiting for approval.`}
                  href="/admin/reviews"
                  actionLabel="Approve Reviews"
                  onClick={() => setOpen(false)}
                />
              )}
            </>
